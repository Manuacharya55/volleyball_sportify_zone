    ...
    connectedCallback(){
        ...
        <nav class="navigation">
            <ul>
                ...
                <li class="links"><a href="../Football/index.html" class="nav-links"><i class="fa-sharp fa-regular fa-futbol"></i>
                ...
                <li class="links"><a href="../Cricket/index.html" class="nav-links"><i class="fa-solid fa-baseball"></i><span
                            class="tooltiptext">Cricket</span></a></li>

                <li class="links"><a href="../Kabaddi/index.html" class="nav-links"><i class="fa-solid fa-person-walking"></i><span
